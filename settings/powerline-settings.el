;; Based on
;; https://www.reddit.com/r/emacs/comments/36qo2l/i_tried_to_copy_the_spacemacs_powerline_theme_my/
		  ...
		  (:eval
		   (let* ((active (powerline-selected-window-active))
			  (mode-line (if active 'mode-line 'mode-line-inactive))
                          ...
                          (lhs (list (powerline-raw (number-to-string (window-number)) face3 'l)
                                     (powerline-raw " " face3)
